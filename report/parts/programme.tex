...
L'outil, développé en Python (pour sa simplicité d'utilisation), est
situé dans le dossier \texttt{tests}, et se nomme
\texttt{gengraphs.py}. Il prend en paramètres le nombre de sommets et
le nombre d'arêtes voulus, et génère un graphe avec des arêtes placées
aléatoirement, avec un type (Route, Train ou Avion) également
aléatoire.
